...
mod native {
    ...
    impl NativeWasmType for Memory32 {
        const WASM_TYPE: Type = <<Memory32 as MemorySize>::Native as NativeWasmType>::WASM_TYPE;
        type Abi = <<Memory32 as MemorySize>::Native as NativeWasmType>::Abi;
    }

    impl NativeWasmType for Memory64 {
        const WASM_TYPE: Type = <<Memory64 as MemorySize>::Native as NativeWasmType>::WASM_TYPE;
        type Abi = <<Memory32 as MemorySize>::Native as NativeWasmType>::Abi;
    }
