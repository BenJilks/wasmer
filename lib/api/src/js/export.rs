        ...
        match extern_type {
            ExternType::Memory(memory_type) => {
                if val.is_instance_of::<Memory>() {
                    return Self::Memory(InternalContextHandle::new(
            ...
            ExternType::Global(global_type) => {
                if val.is_instance_of::<Global>() {
                    return Self::Global(InternalContextHandle::new(
                        &mut ctx.as_context_mut().objects_mut(),
            ...
            ExternType::Function(function_type) => {
                if val.is_instance_of::<Function>() {
                    return Self::Function(InternalContextHandle::new(
                        &mut ctx.as_context_mut().objects_mut(),
            ...
            ExternType::Table(table_type) => {
                if val.is_instance_of::<Table>() {
                    return Self::Table(InternalContextHandle::new(
                        &mut ctx.as_context_mut().objects_mut(),
